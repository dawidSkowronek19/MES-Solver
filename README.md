...
* **Nonlinear Stationary Solver (WIP):** Added support for nonlinear stationary problems. The current implementation utilizes the Picard iteration method (successive approximations) to resolve nonlinearities. *Note: This feature is actively being developed (Work in Progress).*
